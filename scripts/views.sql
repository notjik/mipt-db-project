...
SELECT u.id                                                         as user_id,
       ...
       (SELECT COUNT(*)
        ...
        WHERE lt4.user_id = u.id
          AND lt4.listened_at >= CURRENT_DATE - INTERVAL '30 days') as listens_last_30_days,
       ...
       (SELECT ROUND(AVG(t5.duration)::numeric, 0)
        ...
        WHERE lt5.user_id = u.id)                                   as avg_track_duration_seconds

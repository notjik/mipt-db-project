...
5. **tracks** - содержит информацию о музыкальных треках
    ...
    - `genre_id` (FK) - связь с жанром (опционально)
...
6. **playlists** - хранит информацию о плейлистах пользователей
...
7. **playlist_tracks** - связующая таблица между плейлистами и треками (многие-ко-многим)
...
- Трек принадлежит одному жанру (N:1, опциональная связь)
...
Отношение `playlist_tracks` специально выделено в отдельную таблицу для представления связи многие-ко-многим между плейлистами и треками, что соответствует принципам нормализации.
